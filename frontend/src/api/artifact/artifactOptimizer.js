...
export const startOptimization=(uid,selection)=>data(service.post(`${root}/jobs`,selection,{params:{uid},silentError:true}))
...
export const searchCommunity=(input,signal)=>data(service.post(`${root}/community/search`,input,{signal,silentError:true}))
export const previewCommunity=(input,signal)=>data(service.post(`${root}/community/preview`,input,{signal,silentError:true}))
export const outlineScript=(source,signal)=>data(service.post(`${root}/community/outline`,{source},{signal,silentError:true}))

export const preferenceOptions=[{value:'balanced',label:'均衡',description:'最大化去重场景的加权实际总 每秒伤害'}, {value:'peak',label:'保尖',description:'按角色和 方案 权重保障个人目标'}, {value:'fallback',label:'兜底',description:'依次减少最严重的加权目标短缺'}]
...
export function newBuild(id=crypto.randomUUID()){return {id,name:'新的配队 方案',weight:1,duration:60,enemyLevel:100,resistance:0.1,enemyCount:1,members:[],rotation:'',rounds:[],constraints:[],buffs:[],allowPartial:false}}
